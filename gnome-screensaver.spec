...
Source0:	http://ftp.gnome.org/pub/GNOME/sources/gnome-screensaver/2.25/%{name}-%{version}.tar.bz2
# Source0-md5:	e0aa87be6034e0274103f0ef30c1d31d
Source1:	%{name}.pamd
...
BuildRequires:	gnome-desktop-devel >= 2.25.92
