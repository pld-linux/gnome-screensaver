...
Source0:	http://ftp.gnome.org/pub/gnome/sources/gnome-screensaver/2.19/%{name}-%{version}.tar.bz2
# Source0-md5:	d70d424b3406b8cde5300cea8cff75af
Source1:	%{name}.pamd
...
BuildRequires:	gtk+2-devel >= 2:2.11.5
